...
class BitbucketConfig(BaseModel):
    ...
    diff_max_chars: int = Field(
        default=10000, description="Maximum characters to return for diffs"
    )
    ...
    def from_env(cls) -> Self:
        ...
        return cls(
            ...
            diff_max_chars=int(os.environ.get("BITBUCKET_DIFF_MAX_CHARS", 10000)),
            request_timeout=int(os.environ.get("BITBUCKET_REQUEST_TIMEOUT", 30)),
        )
